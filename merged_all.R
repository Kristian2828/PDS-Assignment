...
tabPanel("Vaccinnation", value = "Vaccination",
         sidebarLayout(
           ...
           mainPanel(
             ...
             tabsetPanel(type = "tabs",
                         ...
                         tabPanel("Vaccination Table", h4("Vaccinations for COVID-19 in South East Asia"), br(),
  ...
  tabPanel("About us", value = "About us",
           sidebarLayout(
             sidebarPanel(strong(h4("PREPARED BY"), br(),strong("Kristian Alexander , Daniel , Eva , Shu Mei and Ezlan"))),
              mainPanel(""),
))))
